      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
             ...
             <div className="bg-white rounded-xl overflow-hidden shadow-sm border border-slate-100 h-80 w-full">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3501.4457055626995!2d77.36825200000001!3d28.646370400000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfaafc96fd5a5%3A0x72bf3253b097bb59!2sTST%20Technologies!5e0!3m2!1sen!2sin!4v1763731321243!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  ...
                  title="TST Technologies Location"
                ></iframe>
             </div>
          </div>
